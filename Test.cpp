...
TEST_CASE("bad tests")
{
    ...
    CHECK_THROWS(tree_of_ints.add_left(9,1) );     // Now 9 is the left child of 1
    ...
    CHECK_THROWS(tree_of_ints.add_left(3,7) );     // 
    CHECK_NOTHROW(tree_of_ints.add_right(9, 5)  );   // Now 5 is the right child of 9
    CHECK_THROWS(tree_of_ints.add_right(3, 5)  );   //
    CHECK_NOTHROW(tree_of_ints.add_right(1, 3) );    // Now 3 is the right child of 1
    CHECK_THROWS(tree_of_ints.add_right(20, 19)  );   //
    CHECK_THROWS(tree_of_ints.add_right(30, 5)  );   //
    ...
    for (const string& element: tree_of_strings) {  // this should work like inorder
        vec_check_str.push_back(element);
    }   // prints: 4 2 5 1 3 
    CHECK_EQ(vec_check_str,vec_ans_str);
    vec_check_str.clear();
    vec_ans_str.clear();
